UPDATE data.tb_osc SET bosc_geometry=(select loca_geometry from data.tb_localizacao where tb_localizacao.bosc_sq_osc = tb_osc.bosc_sq_osc)
 WHERE bosc_sq_osc = 272763;
